...
- **summary.html** … TL;DR・背景・手法・実験結果・個人的ポイントなどを、論文の構成に合わせて日本語でまとめた読みやすい HTML。Anthropic Claude の Web デザイン言語（温かいクリーム地・セリフ見出し・コーラルの単一アクセント・余白重視のエディトリアル構成）を採り入れたスタイル内蔵で、本文は読みやすい幅（最大 820px・中央寄せ）に収めてそのままブラウザで開けます。
